    ...
    return(
        <div className="px-4">Index page here FROM JOM'S BRANCH
            ...
            <Link to={'/booking'}>
                ...
                transform active:scale-x-100 transition-transform transition ease-in delay-100 hover:-translate-y-1 hover:drop-shadow-xl duration-300 "> NO APPOINTMENT</button>
            </Link>
            </div>
        </div>
    )
