            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <div>
                ...
                <div class="relative flex items-center">
                  ...
                  name="registerFirstName" type="text"  class="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-thePointPink px-2 py-3 outline-none" placeholder="First name" />
