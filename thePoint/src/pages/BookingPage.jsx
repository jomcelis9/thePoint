                            ...
                            <form className="mx-auto p-6 border rounded-xl shadow-md shadow-white bg-white m-10">
                                ...
                                <div className="grid md:grid-cols-2 md:gap-7 rounded-md py-2 mb-3">    
                                    ...
                                    <div class=" flex mt-7 justify-center">
                                        <Link to={"/payment"}>
                                            <button type="button" class="bg-thePointRed w-25 text-white bg-primary-600 focus:ring-2 focus:outline-none focus:ring-amber-200 font-medium rounded-2xl text-sm px-5 py-2 text-center 
