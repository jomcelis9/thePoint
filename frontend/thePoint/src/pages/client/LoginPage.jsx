            ...
            <div className="flex flex-col items-center justify-center ">
              ...
              <div class="mb-12">
                ...
                <p class="text-sm mt-4 text-gray-800">Don't have an account 
                  <Link to={"/register"}>
                  <a class="text-thePointRed font-semibold hover:underline ml-1 whitespace-nowrap">
                  Register here</a>
                  </Link>
                </p>
              </div>
              ...
              <div class="flex flex-wrap items-center justify-between gap-4 mt-6">
                ...
                <div>
                  <Link to="/forgot-password" className="text-orange-500 font-semibold text-sm hover:underline">
                    Forgot Password?
                  </Link>
                </div>
              </div>
