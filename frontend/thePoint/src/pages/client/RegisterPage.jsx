            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  ...
                  name="registerFirstName" type="text"  className="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-thePointPink px-2 py-3 outline-none" placeholder="First name" />
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  ...
                  name="registerEmail" type="text"  className="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-thePointPink px-2 py-3 outline-none" placeholder="Enter email" />
                  <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" className="w-[18px] h-[18px] absolute right-2" viewBox="0 0 682.667 682.667">
                    <defs>
                      <clipPath id="a" clipPathUnits="userSpaceOnUse">
                        <path d="M0 512h512V0H0Z" data-original="#000000"></path>
              ...
              <div className="mt-4">
                ...
                <div className="relative flex items-center">
                  ...
                  name="registerPassword" type="password"  className="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-thePointPink px-2 py-3 outline-none" placeholder="Enter password" />
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 mt-6">
                ...
                <div>
                  <a href="jajvascript:void(0);" className="text-orange-500 font-semibold text-sm hover:underline">
                    Forgot Password?
                  </a>
                </div>
              </div>
              ...
              <div className="mt-12">
                <button id="registerBtn" type="submit" className="bg-gradient-to-r from-thePointRed to-thePointPink w-full text-white bg-primary-600 focus:ring-2 focus:outline-none focus:ring-amber-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center 
