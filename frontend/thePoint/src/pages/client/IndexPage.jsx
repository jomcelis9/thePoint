      ...
      <div id="Home" className="px-0 overflow-x-hidden">
        ...
        <div className="font-sans relative flex justify-center items-center h-screen w-screen overflow-x-hidden">
          ...
          <div className="relative z-10 flex flex-col items-start px-4 md:px-32">
            ...
            <p
              className="text-white font-mono font-normal text-lg md:text-1xl mb-30 md:mb-3 max-w-lg"
              style={{ marginLeft: "-550px", marginTop: "13px" }}
            >
              Embrace a Healthier, Happier You with Our Personalized Therapy
              Services, Designed to Support Your Unique Needs Every Step of the
              Way.
            </p>
            ...
            <div className="md:flex md:items-center md:space-x-8">
              ...
              <div className="md:w-1/2">
                <p className="text-2xl leading-relaxed">
                  Point Needs Awareness Clinic is a specialized therapy center
                  dedicated to serving individuals with diverse needs, including
                  children with special needs, persons with disabilities (PWD),
                  and those requiring physical rehabilitation. Our clinic offers
                  a wide range of therapy services tailored to each client’s
                  unique requirements, promoting holistic well-being and
                  independence. With a team of certified therapists, we provide
                  speech therapy, occupational therapy, physical therapy, and
                  more, utilizing evidence-based practices to deliver
                  personalized care. Our mission is to create an inclusive and
                  supportive environment where every individual can thrive and
            ...
            <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3 justify-items-center">
              ...
              <div className="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30 rounded-lg">
                ...
                <div className="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                  ...
                  <p className="mb-3 text-lg italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                    Point Needs Awareness Clinic was established in 2018 with
                    the vision of providing accessible and high-quality therapy
                    services to children with special needs and persons with
                    disabilities (PWD).
                  </p>
                </div>
              </div>
              ...
              <div className="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30 rounded-lg">
                ...
                <div className="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                  ...
                  <p className="mb-3 text-lg italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                    Over the years, the clinic expanded its services to include
                    occupational therapy, physical therapy, and speech therapy,
                    ensuring that each client received comprehensive and
                    customized care.
                  </p>
                </div>
              </div>
              ...
              <div className="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30 rounded-lg">
                ...
                <div className="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                  ...
                  <p className="mb-3 text-lg italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                    The clinic actively engages with the community through
                    workshops and outreach programs, raising awareness about the
                    needs of individuals with disabilities and promoting
                    inclusivity.
                  </p>
                </div>
              </div>
          ...
          <div>
            ...
            <div className="text-center py-4">
              ...
              >
                ...
                <span
                  className={`transform ${
                    isGalleryVisible ? "rotate-180" : "rotate-0"
            ...
            <div className="md:flex md:items-center md:space-x-8">
              ...
              <div className="md:w-1/2 mt-0 md:mt-0">
                <p className="text-2xl text-gray-700 mb-4">
                  We are located in 46 Riverpark Subdivision, Kidapawan City,
                  9400 Cotabato. Our center provides support, education, and
                  awareness for people with special needs in the local
                  community. We aim to create a more inclusive environment and
                  offer resources to help individuals and families.
                </p>
                <p className="text-gray-900">
                  Address: The Point Special Needs Awareness, 46 Riverpark
                  Subdivision, Kidapawan City, 9400 Cotabato
                </p>
              </div>
            </div>
          </section>
