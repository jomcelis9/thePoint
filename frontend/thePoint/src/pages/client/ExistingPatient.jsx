            ...
            <div className="w-full max-w-md">
                ...
                <form className="bg-white p-6 rounded-lg shadow-md w-full">
                    <div className="mb-5">
                        ...
                        <select name="therapyType" className="mb-4 shadow-md rounded-lg w-full text-gray-800 text-sm border-b border-gray-300 focus:border-thePointPink px-2 py-3 outline-none">
